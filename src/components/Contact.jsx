        ...
        <div className="grid lg:grid-cols-2 gap-12">
          ...
          >
            ...
            <div className="rounded-2xl p-7 border" style={{ background: '#faf4fa', borderColor: '#dcbad4' }}>
              <h3 className="text-xl font-bold mb-5" style={{ color: '#202221' }}>Book a Free Consultation</h3>
              {submitted ? (
                <motion.div
                ...
                <form onSubmit={handleSubmit} className="space-y-4">
                  <div className="grid sm:grid-cols-2 gap-4">
                    <div>
                      ...
                      <input required type="text" value={form.name} onChange={(e) => setForm({ ...form, name: e.target.value })}
                        placeholder="Your full name" className="w-full px-4 py-2.5 border rounded-lg text-sm outline-none transition-all"
                    ...
                    <div>
                      ...
                      <input required type="tel" value={form.phone} onChange={(e) => setForm({ ...form, phone: e.target.value })}
                        placeholder="+92 3XX XXXXXXX" className="w-full px-4 py-2.5 border rounded-lg text-sm outline-none transition-all"
                        style={{ borderColor: '#c995bd' }}
                        onFocus={(e) => (e.target.style.borderColor = '#8e2778')}
                        onBlur={(e) => (e.target.style.borderColor = '#c995bd')} />
                    </div>
                  ...
                  <div>
                    ...
                    <input type="email" value={form.email} onChange={(e) => setForm({ ...form, email: e.target.value })}
                      placeholder="you@example.com" className="w-full px-4 py-2.5 border rounded-lg text-sm outline-none transition-all"
                      style={{ borderColor: '#c995bd' }}
                      onFocus={(e) => (e.target.style.borderColor = '#8e2778')}
                      onBlur={(e) => (e.target.style.borderColor = '#c995bd')} />
                  </div>
                  ...
                  <div>
                    ...
                    <textarea value={form.message} onChange={(e) => setForm({ ...form, message: e.target.value })}
                      rows={3} placeholder="Tell us about your goals..."
