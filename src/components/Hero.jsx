...
export default function Hero() {
  ...
  return (
    ...
    >
      ...
      {/* Decorative blobs */}
      <div className="absolute top-20 right-10 w-72 h-72 bg-yellow-400 rounded-full mix-blend-multiply filter blur-3xl opacity-20 animate-pulse" />
      <div className="absolute bottom-20 left-10 w-64 h-64 bg-blue-300 rounded-full mix-blend-multiply filter blur-3xl opacity-20" />

      <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pt-24 pb-20">
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          {/* Left content */}
          <div>
            <div className="inline-flex items-center gap-2 bg-white/10 backdrop-blur-sm text-yellow-300 text-sm font-semibold px-4 py-2 rounded-full border border-yellow-400/30 mb-6">
            ...
            <div className="flex flex-col sm:flex-row gap-4">
              <button
                ...
                className="inline-flex items-center justify-center gap-2 bg-yellow-500 hover:bg-yellow-400 text-blue-900 font-bold py-4 px-8 rounded-xl transition-all duration-200 shadow-xl hover:shadow-yellow-500/25 hover:-translate-y-0.5 text-lg"
              >
                Get Free Counseling
                <ArrowRight size={20} />
              </button>
