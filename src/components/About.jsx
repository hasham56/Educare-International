      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid lg:grid-cols-2 gap-16 items-center">
          ...
          <div className="relative">
            <div className="relative rounded-3xl overflow-hidden shadow-2xl bg-gradient-to-br from-blue-600 to-blue-900 aspect-[4/3]">
              {/* Decorative illustration */}
              <div className="absolute inset-0 flex items-center justify-center">
                <div className="text-center text-white">
                  <div className="text-8xl mb-4">🎓</div>
                  <div className="text-2xl font-bold">EduCare International</div>
                  <div className="text-blue-200 mt-1">Lahore, Pakistan</div>
                </div>
              </div>
              {/* Grid overlay */}
            ...
            {/* Floating badge */}
            <div className="absolute -bottom-6 -right-6 bg-yellow-400 text-blue-900 rounded-2xl p-5 shadow-xl font-bold text-center">
            ...
            <div className="grid grid-cols-2 gap-4 mt-12">
              {stats.map(({ icon, value, label }) => (
                <div key={label} className="bg-gray-50 rounded-xl p-4 flex items-center gap-3 border border-gray-100">
                  <div className="bg-blue-100 text-blue-600 p-2.5 rounded-lg flex-shrink-0">{icon}</div>
                  <div>
