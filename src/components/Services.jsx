      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-7">
          {services.map((service) => (
            <div
              key={service.title}
              className="relative rounded-2xl border bg-white hover:shadow-xl transition-all duration-300 hover:-translate-y-1 flex flex-col overflow-hidden"
            ...
            >
              ...
              <div className="p-6 flex flex-col flex-1">
                ...
                <h3 className="text-xl font-bold mb-3" style={{ color: '#202221' }}>
                  {service.title}
                </h3>
                <p className="text-sm leading-relaxed mb-5" style={{ color: '#888085' }}>
                  {service.description}
                </p>
